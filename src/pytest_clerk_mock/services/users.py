...
def _build_trusted_device(
    *,
    trusted_device_id: str,
    status: models.TrustedDeviceStatus,
) -> models.TrustedDevice:
    """Build a minimal TrustedDevice payload."""

    return models.TrustedDevice.model_validate(
        {
            "object": models.TrustedDeviceObject.TRUSTED_DEVICE,
            "id": trusted_device_id,
            "platform": models.Platform.IOS,
            "app_identifier": "app.clerk.mock",
            "algorithm": models.Algorithm.ES256,
            "status": status,
            "created_at": 0,
            "updated_at": 0,
        }
...
class MockUsersClient:
    ...
    def revoke_trusted_device(
        ...
        *,
        ...
        return _build_trusted_device(
            trusted_device_id=trusted_device_id,
            status=models.TrustedDeviceStatus.REVOKED,
        )
